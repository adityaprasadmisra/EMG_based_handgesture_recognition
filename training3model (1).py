...
# ═══════════════════════════════════════════════════════════════
#  SECTION 1 — LOAD AND COMBINE ALL 3 CSV FILES
# ═══════════════════════════════════════════════════════════════
...
print(f"\n  Samples per gesture (combined):")
print(df['gesture'].value_counts().to_string())
print(f"\n  Samples per person:")
print(df['person'].value_counts().to_string())
print(f"\n  Signal statistics:")
...
plt.suptitle('Raw EMG Signal Per Gesture — All 3 Persons (first 200 samples)', fontsize=13, y=1.01)
plt.tight_layout()
...
colors = ['tab:blue'] * 5 + ['tab:orange'] * 5 + ['tab:green'] * 3
plt.bar(feature_names, importances, color=colors)
plt.xticks(rotation=45, ha='right')
plt.ylabel('Importance score')
plt.title('Feature Importance — Random Forest\n(blue=EMG1, orange=EMG2, green=IMU)',
          fontweight='bold')
plt.tight_layout()
